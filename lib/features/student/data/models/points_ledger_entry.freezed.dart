...
abstract class $PointsLedgerEntryCopyWith<$Res> {
  factory $PointsLedgerEntryCopyWith(
          PointsLedgerEntry value, $Res Function(PointsLedgerEntry) then) =
...
abstract class _$$PointsLedgerEntryImplCopyWith<$Res>
    implements $PointsLedgerEntryCopyWith<$Res> {
  factory _$$PointsLedgerEntryImplCopyWith(_$PointsLedgerEntryImpl value,
...
class __$$PointsLedgerEntryImplCopyWithImpl<$Res>
  ...
  __$$PointsLedgerEntryImplCopyWithImpl(_$PointsLedgerEntryImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PointsLedgerEntryImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$PointsLedgerEntryImpl extends _PointsLedgerEntry {
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, studentId, delta,
      runningTotal, reason, issuedByUid, issuedByName, createdAt, syncStatus);
  ...
  Map<String, dynamic> toJson() {
    return _$$PointsLedgerEntryImplToJson(
      this,
    );
  }
}
...
abstract class _PointsLedgerEntry extends PointsLedgerEntry {
  const factory _PointsLedgerEntry(
      ...
      @HiveField(8) final SyncStatus syncStatus}) = _$PointsLedgerEntryImpl;
