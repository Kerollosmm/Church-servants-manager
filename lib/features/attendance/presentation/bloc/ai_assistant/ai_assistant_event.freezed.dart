...
class _$SendQueryImpl implements SendQuery {
  const _$SendQueryImpl(
      {required this.query, final Map<String, dynamic>? contextData})
  ...
  int get hashCode => Object.hash(
      runtimeType, query, const DeepCollectionEquality().hash(_contextData));
...
abstract class SendQuery implements AIAssistantEvent {
  const factory SendQuery(
      ...
      final Map<String, dynamic>? contextData}) = _$SendQueryImpl;
