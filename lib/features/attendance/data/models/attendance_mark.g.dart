...
_$AttendanceMarkImpl _$$AttendanceMarkImplFromJson(Map<String, dynamic> json) =>
    _$AttendanceMarkImpl(
      ...
      markedAt: const RequiredFirestoreTimestampConverter().fromJson(
        json['markedAt'],
      ),
      updatedAt: const RequiredFirestoreTimestampConverter().fromJson(
        json['updatedAt'],
      ),
      serverUpdatedAt: const FirestoreTimestampConverter().fromJson(
...
Map<String, dynamic> _$$AttendanceMarkImplToJson(
  ...
  'status': const AttendanceMarkStatusJsonConverter().toJson(instance.status),
  'markedByUserId': instance.markedByUserId,
  'markedByName': instance.markedByName,
  'markedAt': const RequiredFirestoreTimestampConverter().toJson(
    instance.markedAt,
  ),
  'updatedAt': const RequiredFirestoreTimestampConverter().toJson(
    instance.updatedAt,
  ),
  'serverUpdatedAt': const FirestoreTimestampConverter().toJson(
    instance.serverUpdatedAt,
  ),
  'note': instance.note,
};
