...
mixin _$ServantModel {
  ...
  @HiveField(23)
  List<String> get assignedSectorIds => throw _privateConstructorUsedError;
...
abstract class $ServantModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(23) List<String> assignedSectorIds});
}
    ...
    return _then(_value.copyWith(
      ...
      clientUpdatedAt: freezed == clientUpdatedAt
          ...
          : clientUpdatedAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      assignedSectorIds: null == assignedSectorIds
          ? _value.assignedSectorIds
          : assignedSectorIds // ignore: cast_nullable_to_non_nullable
              as List<String>,
    ) as $Val);
  }
}
...
class _$ServantModelImpl extends _ServantModel {
  const _$ServantModelImpl(
      ...
      @HiveField(23) final List<String> assignedSectorIds = const <String>[]})
      : _assignedTeamIds = assignedTeamIds,
        _groupAttendanceSummary = groupAttendanceSummary,
        _assignedSectorIds = assignedSectorIds,
        super._();
  ...
  /// Sectors this servant is authorised to manage (e.g. ['primary_boys', 'youth']).
  /// Used for sector-scoped RBAC in Firestore Security Rules.
  final List<String> _assignedSectorIds;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other._groupAttendanceSummary, _groupAttendanceSummary) &&
            (identical(other.syncStatus, syncStatus) ||
                other.syncStatus == syncStatus) &&
            (identical(other.clientUpdatedAt, clientUpdatedAt) ||
                other.clientUpdatedAt == clientUpdatedAt) &&
            const DeepCollectionEquality()
                .equals(other._assignedSectorIds, _assignedSectorIds));
  }
  ...
  int get hashCode => Object.hashAll([
        ...
        syncStatus,
        clientUpdatedAt,
        const DeepCollectionEquality().hash(_assignedSectorIds)
      ]);
...
abstract class _ServantModel extends ServantModel {
  const factory _ServantModel(
          ...
          @HiveField(23) final List<String> assignedSectorIds}) =
      _$ServantModelImpl;
