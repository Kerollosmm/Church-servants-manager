class Validators {
  ...
  static String? validatePhone(String? value) {
    ...
    if (!_phoneRegex.hasMatch(value.trim())) return 'Enter a valid 11-digit phone number';
    return null;
  }
  ...
  static String? validateEmailArabic(String? value) {
    ...
    if (!_emailRegex.hasMatch(value!.trim())) return 'أدخل بريدا إلكترونيا صحيحا';
    return null;
  }
  ...
  static String? validateNameArabic(String? value) {
    if (_isEmpty(value)) return 'الاسم مطلوب';
  ...
  static String? validatePhoneArabic(String? value) {
    ...
    if (!_phoneRegex.hasMatch(value!.trim())) return 'أدخل رقم هاتف صحيح مكون من 11 رقما';
    return null;
  }
