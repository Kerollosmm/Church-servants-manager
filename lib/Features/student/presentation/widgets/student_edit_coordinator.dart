...
class StudentEditCoordinator extends StatefulWidget {
  const StudentEditCoordinator({super.key, required this.args});

  final StudentEditArgs args;

  @override
  State<StudentEditCoordinator> createState() => _StudentEditCoordinatorState();
}

class _StudentEditCoordinatorState extends State<StudentEditCoordinator> {
