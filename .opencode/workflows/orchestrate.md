...
Usage: `/orchestrate <complex_task_description>`

Describe the multi-domain task you need coordinated. The orchestrator will activate 3+ specialized agents.

**Examples:**
```text
/orchestrate build a full authentication flow with Firebase, UI screens, and unit tests
/orchestrate review and harden the student data API for security, performance, and test coverage
/orchestrate add payment integration with backend, frontend, and deployment pipeline
```
