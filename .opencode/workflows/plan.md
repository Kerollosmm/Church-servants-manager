...
Describe the feature or work you want planned. The planner will create `docs/PLAN-{slug}.md` containing a phased breakdown with task assignments and verification steps. **No code is written** — only the plan file.
